/**
 * EmployeeMain2 - an employee management to do the following
 * set details including allowances for all employees and managers
 * calculate gross pay and tax payable
 * print pay slip for an employees
 * print monthly wagebill
 *
 */
import java.util.*;
class Employee{
...
/*//Creating objects of Type Managers
 ...
 printPaySlip(Mger);
 */ 
//Creating An array of objects of Type Managers
...
public static float getGross(Manager M){
 return M.getSalary()+M.getHseAllowance()+M.getTravAllowance()+M.getOfficAllowance()
+M.getMedAllowance();
}
